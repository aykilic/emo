...
//     })
// }
const doorsendmail = async (datam)=>{
  // console.log("__dirname",__dirname);
await ejs.renderFile(__dirname + "/doormail.ejs", { sipno:datam.sipno,username:datam.username,usermail:datam.usermail,confirm_link: "http://www.8link.in" }, function (err, data) {
  if (err) {
      console.log(err);
  } else {
      var mainOptions = {
...
exports.doorsendmail = doorsendmail