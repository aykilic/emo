...
<!--    <mdc-button >click me</mdc-button>-->
    ...
    <q-card class="col-md-10 row offset-md-1 col-sm-10 offset-sm-1 col-xs-12">
      ...
      <q-card class="col-md-4  col-sm-10 offset-sm-1 col-xs-12 "
              title=""
      >
...
<!--        <q-card class="col-10 offset-1">-->
          ...
          >
            <q-card  style="width: 500px; max-width: 80vw;">
              ...
              <q-card-section >
                <q-input class="q-pa-md" outlined v-model="editedItem.stokturad" label="Adı" :dense=false />
                <q-select
              ...
              <q-card-section  class="text-right">
                ...
                <q-btn class="q-ma-sm"  color="primary" label="Güncelle" @click="updateStoktur(editedItem)" v-close-popup ></q-btn>
                <q-btn class="q-mr-md"  color="negative" label="Sil" @click="deleteStoktur(editedItem)" v-close-popup ></q-btn>
              </q-card-section>
            </q-card>
          </q-dialog>
      ...
      <q-card class="col-md-5  col-sm-10 offset-sm-1 col-xs-12 "
              title=""
      >
        <q-card class="col-12 " title="">
          <q-card-section>
            ...
            <q-input class="q-pa-md " outlined v-model="stokturad" label="Adı" :dense=false />
          <q-card-section>
            <div class="text-h6 text-center" >Üst Kategori <br>
            ...
            <q-input class="q-pa-md kategori" outlined v-model="ustkategoriad" placeholder="ANA KATEGORİ" :dense=false disable/>
...
<q-card class="col-md-10 row offset-md-1 col-sm-10 offset-sm-1 col-xs-12">
      ...
      <q-card class="col-md-10  col-sm-10 offset-sm-1 col-xs-12 "
              title=""
      >
    ...
    methods: {
      ...
      deleteStoktur(item){
        ...
        if(this.isChildren > 0){
            ...
            this.$apollo.mutate({
            mutation: gql`mutation deleteStoktur($id: String!){
      ...
      filterFn (val, update, abort) {
        ...
        update(() => {
          ...
          this.options = this.Query.filter(v => v.stokturad.toLowerCase().includes(needle))
        })
      },
      // <input (val) {
      //   this.notif();
