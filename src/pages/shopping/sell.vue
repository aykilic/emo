<template>
  <div class="row col-12 justify-center q-pt-xl">
    ...
    <q-stepper
      ...
      animated
    >
      <q-step class :name="1" title icon="mdi-cart" :done=" step > 1 " style>
        <div class="row justify-center">
          <div class="row q-gutter-y-md col-md-10">
            <div
              class="col-xs-12 col-md-8"
              style="border-style:solid;border-color:#cdcdcd;border-width: 1px;border-radius:5px;"
            >
              <q-table
                flat
                :data="lists"
                ...
                <template v-slot:body="props">
                  ...
                  <q-tr :props="props" class="cursor-pointer">
                    ...
                    <q-td class style key="resim" :props="props">
                      ...
                      <div
                        class="text-red text-weight-bold scale-down justify-center"
                        style="margin-left: auto;margin-right: auto;white-space: normal;"
                        v-else-if=" props.row.miktar==0"
                      >
                    ...
                    <q-td class="text-weight-bold" key="stokad" :props="props">
                      ...
                      {{props.row.stokad}}
                      <br />
                      {{props.row.varyantoption1}}
                      <br />
                      {{props.row.varyantoption2}}
                      <!-- </div> -->
                    </q-td>
                    <q-td
                      class
                      key="miktar"
                      :props="props"
                      v-if="props.selected==false ? props.row.count=1:props.row.count"
                    >
                      <!-- TODO: -->
                      <!-- <q-input
                    ...
                    <q-td
                      ...
                      key="fiyat"
                      :props="props"
                    >{{formatPrice(props.row.fiyat)}} TL</q-td>
                    <q-td key="delete" :props="props">
                      ...
                      <q-btn
                        ...
                        icon="delete"
                        color="grey-7"
                        @click="delete_basketproduct(props.row._id),load=true"
                        flat
                        round
                      ></q-btn>
                    </q-td>
            ...
            <div
              class="col-12 col-md ozet"
              style="border-style:solid;border-color:#cdcdcd;border-width: 1px;border-radius:5px;display:block;min-width:150px;max-height:295px"
            >
              <q-card flat>
                <q-card-section>
                  <div class="row">
                  ...
                  <q-stepper-navigation>
                    <q-btn
                      @click="selected.length >= 1 ? $refs.stepper.next() : devam()"
                      class="q-px-xl"
                      size="lg"
                      color="primary"
                      :label="step === 3 ? 'Finish' : 'Devam'"
                      rounded
                    />
                    <q-btn
                      v-if="step > 1"
      ...
      <!-- -------------------------------------------------------------------- -->
      <q-step :name="2" title icon="mdi-map-marker-alert" :done="step > 2">
        <div class="row justify-center">
          <div class="row q-gutter-y-md col-md-10">
            <div
              class="col-xs-12 col-md-8"
            ...
            >
              <div class="row">
                <q-item-label
                  class="q-pa-md col-12 text-weight-medium"
                  style="font-size:19px"
                >Sipariş Bilgileri</q-item-label>
                <q-separator class="q-mb-md" />
                <div class="row" v-if="get_guid">
                  <q-input
                    class="q-pt-md q-pl-xs q-pr-xs col-6"
                    v-model="user.ad_soyad"
                    ref="ad"
                  ...
                  <q-input
                    ...
                    v-model="user.cep"
                    ref="cep"
                    :rules="[val => val.length > 9 || 'Yanlış Numara']"
                    mask="+90(###) ### - ####"
                    unmasked-value
                    outlined
                    label="Cep Telefonu"
                  ...
                  />
                  <q-input
                    class="q-pt-xs q-pl-xs q-pr-xs col-6"
                    v-model="user.tc_v_no"
                    ref="tc"
                    :rules="[val => !!val || 'Boş Bırakmayınız']"
                    outlined
                    label="TC Kimlik No-Vergi No"
                    hint="Lütfen Adınızı Giriniz"
                    dense
                  />
                  <q-input
                    class="q-pt-xs q-pl-xs q-pr-xs col-6"
                    v-model="user.v_daire"
                    outlined
                    label="Vergi Dairesi"
                    hint="Varsa - Vergi Dairesi Giriniz"
                    dense
                  />
                  <q-input
                    class="q-pt-xs q-pl-xs q-pr-xs col-12"
                    v-model="user.email"
                    ref="email"
                    outlined
                    label="Mail"
                    hint="Lütfen Mail Giriniz"
                    :rules="[val => !!val || 'Email Alanı', isValidEmail]"
                    dense
                  />
                  <q-input
                    outlined
                ...
                <div class="row col-12" v-else>
                  <div
                    class="col-md-4 col-xs-6 q-pa-xs"
                    v-for="(get_userdetaillist ,index) in get_userdetaillists"
                    :key="index"
                  >
                    <q-card
                      class="new_detail"
                    ...
                    >
                      <q-card-section
                        @click="user=get_userdetaillist;selectdetail(get_userdetaillists,index)"
                        style="height:170px;"
                      >
                        <!-- <div class="text-h6">Our Changing Planet</div> -->
                        <div
                          class="col-5 text-subtitle2 text-left"
                        >{{get_userdetaillist.baslik}} - {{get_userdetaillist.ad_soyad}}</div>
                        ...
                        >{{get_userdetaillist.il}} - {{get_userdetaillist.ilce}}</div>
                      ...
                      <q-card-actions align="right">
                        <q-btn
                          color="primary"
                          @click="user=get_userdetaillist;user_detail_dialog = !user_detail_dialog;edit_adress=true"
                          flat
                          rounded
                        >Düzenle</q-btn>
                        <q-btn
                          color="red"
                          @click="selectadresid=get_userdetaillist._id,adressildialog=true"
                          flat
                          rounded
                        >Sil</q-btn>
                      </q-card-actions>
                  ...
                  <q-card
                    class="col q-ma-xs"
                    @click="user={};user_detail_dialog = !user_detail_dialog; edit_adress=false "
                  >
            ...
            <div
              class="col-12 col-md ozet"
              style="border-style:solid;border-color:#cdcdcd;border-width: 1px;border-radius:5px;display:block;min-width:150px;max-height:345px"
            >
              <q-card flat>
                <q-card-section>
                  <div class="row">
      ...
      <!-- -------------------------------------------------------------------- -->
      <q-step :name="3" title icon="mdi-credit-card">
        ...
        <div class="row justify-center">
          <div class="row q-gutter-y-md col-md-10">
            ...
            >
              <div class="row">
                <q-item-label
                  class="q-mb-md q-mt-md col-12 text-weight-medium"
                  style="font-size:19px"
                >Ödeme Seçenekleri</q-item-label>
                <q-separator />
                ...
                <q-list class="col-12" bordered>
                        ...
                        <q-item   tag="label" v-ripple>
                          <q-item-section style="min-width:10px" avatar >
                            ...
                            <q-radio
                              ...
                              v-model="val"
                              val="Kredi Kartı Hemen"
                              @click.native="payment_radio(`${val}`)"
                              color="primary"
                            />
                  ...
                  <q-expansion-item
                    ...
                    label="Banka Havalesi İle Ödeme Yap"
                    header-class
                  >
                    <q-card>
                      <q-separator />
                  ...
                  <q-expansion-item
                    ...
                    label="Ürün Kapınıza Geldiğinde Nakit Öde"
                    header-class
                  >
                    <q-card>
                      <q-separator />
            ...
            <div
              class="col-12 col-md ozet"
              style="border-style:solid;border-color:#cdcdcd;border-width: 1px;border-radius:5px;display:block;min-width:150px"
            >
              <q-card flat>
                <q-card-section>
                  <div class="row">
    ...
    <!-- FIXME: -->
    <q-dialog v-model="user_detail_dialog">
      <q-card class>
        ...
        <q-card-section class="row col-12">
          <q-input
            class="q-pt-md q-pl-xs q-pr-xs col-12"
            v-model="user.baslik"
            ref="baslik"
            :rules="[val => !!val || 'Boş Bırakmayınız']"
            outlined
          ...
          />
          <q-input
            class="q-pt-md q-pl-xs q-pr-xs col-md-6 col-xs-12"
            v-model="user.ad_soyad"
            ref="ad"
            :rules="[val => !!val || 'Boş Bırakmayınız']"
            outlined
          ...
          <q-input
            ...
            v-model="user.cep"
            ref="cep"
            :rules="[val =>!!val, val.length > 9 || 'Yanlış Numara']"
            mask="+90(###) ### - ####"
            unmasked-value
            outlined
            label="Cep Telefonu"
          ...
          />
          <q-input
            class="q-pt-xs q-pl-xs q-pr-xs col-md-6 col-xs-12"
            v-model="user.tc_v_no"
            ref="tc"
            :rules="[val => !!val || 'Boş Bırakmayınız']"
            outlined
        ...
        <q-card-section class="text-right">
          <q-btn
            ...
            class="q-ma-sm"
            color="primary"
            @click="user_det_kaydet(user._id)"
            label="Güncelle"
          ></q-btn>
    ...
    <q-dialog v-model="adressildialog">
      <q-card style="width: 500px; max-width: 80vw;">
        ...
        <q-separator />
        <q-card-section class="row">Adresi Silmek İstediğinizden Eminmisiniz?</q-card-section>
        <q-separator />
        <q-card-section class="text-right">
...
export default {
  ...
  async mounted() {
    ...
    this.get_userdetaillists.forEach((item) => {
      //adres selected hatası için
      item.selected = false;
    });
  ...
  methods: {
    ...
    async tamamla() {
      ...
      await axios
        ...
        .then((data) => {
          ...
          if (data.data.data.son_numaralar == null) {
            ...
            this.numaralar.irsaliyeno =
              data.data.data.son_numaralar.irsaliyeno + 1;
          }
      ...
      function satlistolustur() {
        ...
        vm.selected.forEach((item) => {
          ...
          obj.stokad =
            item.stokad + " " + item.varyantoption1 + " " + item.varyantoption2;
      ...
      if (val === "Kredi Kartı Hemen") {
        ...
        this.$apollo
          .mutate({
            mutation: gql`
              mutation createSiparisFis_mutation(
                $satirList: [satirListInput]
                $siparisfis: siparisfisinput
              ) {
                createSiparisFis_mutation(
                  satirList: $satirList
        ...
        //   paytr  
          .then(async (data) => {
            ...
            var paytr_token = Base64.stringify(
              hmacSHA256(hash_str + merchant_salt, merchant_key, true)
            );
        ...
        this.$apollo
          .mutate({
            mutation: gql`
              mutation havalesendmail_mutation(
                $sipno: Float
                $username: String
                $usermail: String
              ) {
                havalesendmail_mutation(
                  sipno: $sipno
                  username: $username
                  usermail: $usermail
                ) {
        ...
        this.$apollo
          .mutate({
            mutation: gql`
              mutation doorsendmail_mutation(
                $sipno: Float
                $username: String
                $usermail: String
              ) {
                doorsendmail_mutation(
                  sipno: $sipno
                  username: $username
                  usermail: $usermail
                ) {
    ...
    user_det_kaydet(a) {
      ...
      if (
        //    this.user.baslik == "" ||
        this.user.ad_soyad == "" ||
        this.user.ad_soyad == undefined ||
        this.user.tc_v_no == "" ||
        this.user.tc_v_no == undefined ||
        //    this.user.email == "" ||
        this.user.adres == "" ||
        this.user.adres == undefined ||
        this.user.il == "" ||
        this.user.il == undefined ||
        this.user.ilce == "" ||
        this.user.ilce == undefined
      ) {
      ...
      if (this.user_validate) {
        ...
        if (a != undefined) {
          ...
          this.$apollo
            .mutate({
              mutation: gql`
                mutation user_detail_edit_mutation(
                  $id: ID
    ...
    async fonk() {
        ...
        .then((response) => {
          ...
          this.lists.forEach((item, i) => {
            farr.forEach((aitem, a) => {
              if (a == i) {
                this.lists[i].fiyat =
                  aitem.fiyat1 - (aitem.fiyat1 * aitem.indirim) / 100;
              }
            });
          });
        });
      ...
      this.lists.forEach((item, z) => {
        this.getvaryantskuslists.forEach((aitem, a) => {
          //varyantskus
    ...
    hesaplama() {
      ...
      this.selected.forEach((item) => {
        ...
        kdv +=
          item.count * (item.fiyat - item.fiyat / ((100 + item.kdv) / 100));
      });
      // console.log(kdv);
    ...
    delete_basketproduct(val) {
      this.$apollo
        .mutate({
          mutation: gql`
            mutation delete_basketproduct($id: ID) {
    ...
    filteril(value, update, abort) {
      update(() => {
        ...
        this.iloptions = this.ilList.filter((v) =>
          v.il.toLowerCase().includes(needle)
        );
      });
    },
    async ilcesec() {
